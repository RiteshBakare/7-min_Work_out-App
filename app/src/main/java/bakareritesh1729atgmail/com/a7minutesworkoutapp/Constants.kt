...
object Constants {
    ...
    fun defaultExerciseList() : ArrayList<ExerciseModel> {
        ...
        val pushUpAndRotation = ExerciseModel(11,"Push And Rotation",R.drawable.ic_push_up_and_rotation,false,false)
        exerciseList.add(pushUpAndRotation)

        val sidePlank = ExerciseModel(12,"",R.drawable.ic_side_plank,false,false)
